...
public class Ex13 {
     ...
     * The time complexity is O(log n) because of the binary search.
     ...
     * The time complexity of this method is O(n) where n is the length of the array,
     * since we iterate through the array once.
     * The space complexity is O(1) since we only use the variables left, right, maxLeft, maxRight and units.
     *
    ...
    private static String findPassword(Password p, String s, int index) {
        ...
        // the boundaries of the recursion
        ...
        // try with the new char and spilt the recursion
